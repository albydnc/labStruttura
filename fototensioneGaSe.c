...
void fototensioneGaSe()
{
  ...
  // numero misure prese
  const int n = 39;
  double fototensione[]={165,180,198,213,205,218,230,231,233,263,262,224,225,191,180,158,148,143,129,124,111,92,87,82,75,75,74,70,68,68,63,62,55,50,48,50,47,47,51};
