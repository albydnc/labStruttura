...
for(int j=0;j<n;j++){
  ...
  cout << "\n\n --- Fit I(V) \n" <<endl;
  giV->Draw("AP");
  TF1 *funz0 = new TF1("funz0","[0]+[1]/(1+exp((x-[2])/[3]))",560,650);
  funz0->SetLineStyle(1);
  funz0->SetLineColor(2);
  funz0->SetParameter(0,0);
  funz0->SetParameter(1,5);
